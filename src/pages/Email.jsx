...
import { homeToHTML, beginningHTML, endingHTML } from '../components/HTMLConvert';
...
export default function Email() {
  ...
  const renderRecent = async () => {
    ...
    await response.map((home) => {
      ...
      const deposit = home.lots.lots[0].dynamic_fields.find((field) => field.dynamic_field_id === '661').data.value;
